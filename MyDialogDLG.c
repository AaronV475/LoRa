...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { MULTIEDIT_CreateIndirect, "Multiedit", ID_MULTIEDIT_0, 53, 29, 322, 60, 0, 0x0, 0 },
  { MULTIEDIT_CreateIndirect, "Temp", ID_MULTIEDIT_1, 60, 115, 303, 60, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_MULTIEDIT_0: // Notifications sent by 'Multiedit'
      ...
      break;
    case ID_MULTIEDIT_1: // Notifications sent by 'Temp'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
